...
function menuPetShop() {
	alert(
		'Bienvenido al ABM de TU MASCOTA PetShop, pulse Aceptar para continuar con el menú interactivo'
	);
...
do {
	...
	if (opcionElegida == 1) {
		...
		alert('Ingresaste datos erroneos, comencemos de nuevo!');
		break;
	}
